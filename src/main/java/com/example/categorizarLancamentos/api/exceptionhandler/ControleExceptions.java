package com.example.categorizarLancamentos.api.exceptionhandler;
...

{
	...
	public ResponseEntity<Object> handleMethodArgumentNotValid(EmptyResultDataAccessException ex , WebRequest request){
	...
	public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex, WebRequest request){
		...
		String msgDev = ExceptionUtils.getMessage(ex);
		List<Erro> erros = Arrays.asList(new Erro(msg, msgDev));
